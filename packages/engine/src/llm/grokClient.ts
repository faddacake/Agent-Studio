 ...
 * wrapper that points the OpenAIClient at the xAI base URL and names
 * errors "Grok" rather than "OpenAI".
 * https://docs.x.ai/api
 */
...
export function createGrokClient(
  ...
  return new OpenAIClient(apiKey, model, GROK_CHAT_URL, "Grok");
}
